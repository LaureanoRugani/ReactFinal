        ...
        <>
            {compraConfirmada ?
                ...
                <Modal show={show} onHide={handleClose} size='xl' centered  >
                    ...
                    <Modal.Body>
                        <h4>Felicitaciones, su pedido de cotizacion de viaje, fue realizado con exito. Su numero de referencia es: <strong>{idOrder}</strong> </h4>
                    </Modal.Body>
                        ...
                        <Card>
                            <Form className="m-3" onSubmit={validacionDatos}>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicName">
                                    ...
                                    <Form.Control onChange={(e) => updateNombre(e)} type="text" placeholder="Ingrese su nombre" required />
                                </Form.Group>
                                <Form.Group className="mb-3" controlId="formBasicAdress">
                                    <Form.Label className="text-dark">Direccion</Form.Label>
                                    <Form.Control onChange={(e) => updateAddress(e)} type="text" placeholder="Ingrese su direccion" />
                                </Form.Group>
                                <Form.Group className="mb-3" controlId="formBasicPhone">
                                    <Form.Label className="text-dark">Telefono</Form.Label>
                                    <Form.Control onChange={(e) => updatePhone(e)} type="text" required placeholder="Ingrese su numero telefonico" />
                                </Form.Group>
